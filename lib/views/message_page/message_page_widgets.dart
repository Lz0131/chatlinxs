...
import 'package:chatlinxs/helper/music_slider.dart';
...
String _truncateText(String text) {
  const int maxLength = 11; // Define la longitud máxima deseada
  if (text.length <= maxLength) {
    return text;
  } else {
    return text.substring(0, maxLength) + "..."; // Añade puntos suspensivos
  }
}
  ...
  return Container(
    ...
    child: TextFormField(
      ...
      decoration: const InputDecoration(
          ...
          contentPadding:
              EdgeInsets.only(left: 15, bottom: 3, top: 8, right: 15),
          hintText: "Respond...",
